...
# 根目录路径
val_dir = "/home/zrf/datasets/ImageNet_100/val"

# 遍历该目录下所有子文件夹
for name in os.listdir(val_dir):
    subdir = os.path.join(val_dir, name)
    if os.path.isdir(subdir) and name not in keep_dirs:
        print(f"Deleting: {subdir}")
        shutil.rmtree(subdir)

print("Clean Ok!")

dir1 = '/home/zrf/datasets/ImageNet_100/train'
dir2 = '/home/zrf/datasets/ImageNet_100/val'
