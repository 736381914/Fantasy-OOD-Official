...
if args.score == 'Odin':
    ...
    train_data = \
        torchvision.datasets.ImageFolder(
            os.path.join('/home/zrf/datasets/ImageNet_100/', 'train'),
            trn.Compose([
                trn.Resize(256),
                trn.CenterCrop(224),
                trn.ToTensor(),
...
ood_loader = torch.utils.data.DataLoader(
                torchvision.datasets.ImageFolder("/home/zrf/datasets/large_OOD_dataset/iNaturalist",
...
# /////////////// Places365 ///////////////
ood_data = dset.ImageFolder(root="/home/zrf/datasets/large_OOD_dataset/Places",
                            transform=trn.Compose([
    trn.Resize(256),
    trn.CenterCrop(224),
    trn.ToTensor(),
...
# /////////////// sun ///////////////
ood_data = dset.ImageFolder(root="/home/zrf/datasets/large_OOD_dataset/SUN",
                            transform=trn.Compose([
    trn.Resize(256),
    trn.CenterCrop(224),
    trn.ToTensor(),
...
# /////////////// texture ///////////////
ood_data = dset.ImageFolder(root="/home/zrf/datasets/large_OOD_dataset/dtd/images",
                            transform=trn.Compose([
    trn.Resize(256),
    trn.CenterCrop(224),
    trn.ToTensor(),
